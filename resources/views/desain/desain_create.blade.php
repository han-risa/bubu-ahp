            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('desain.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="nama_desain">Nama Desain</label>
                                            <input type="text" id="nama_desain" class="form-control" placeholder="Masukkan nama desain" name="nama_desain">
                                        </div>
                                    </div>
